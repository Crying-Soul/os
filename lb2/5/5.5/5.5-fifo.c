 ...
 *
 * Функциональность:
 * 1. Демонстрация работы политики SCHED_FIFO:
 *    - Установка статического приоритета (1-99)
 *    - CPU-intensive нагрузка в бесконечном цикле
 *    - Периодический вывод информации о процессе
 *
 * 2. Ключевые особенности:
 *    - Требует root-прав для установки SCHED_FIFO
 *    - Жесткое планирование (не вытесняется до завершения)
 *    - Приоритет передается через аргумент командной строки
 */
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
