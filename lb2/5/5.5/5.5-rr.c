 ...
 *
 * Функциональность:
 * 1. Демонстрация стандартной политики SCHED_OTHER:
 *    - Использует completely fair scheduler (CFS)
 *    - Приоритет (nice) игнорируется в реальном времени
 *    - Динамическое распределение ресурсов
 *
 * 2. Особенности:
 *    - Не требует специальных прав
 *    - Автоматическая балансировка нагрузки
 *    - Подходит для обычных пользовательских процессов
 */
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
